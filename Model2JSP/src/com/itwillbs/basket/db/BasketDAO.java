...
public class BasketDAO {
	...
	public int checkGoods(BasketDTO bkdto){
		...
		try {
			...
			System.out.println(" DAO : 장바구니 - 상품체크 ");
	...
	public Vector getBasketList(String id){
		...
		// 장바구니정보 +상품정보 리스트 모두를 저장하는 백터(리스트)
		...
		try {
			...
			while(rs.next()){ // 장바구니 정보가 있을때
				...
				if(rs2.next()){// 장바구니에 저장한 상품정보가 있을때
		   ...
		   System.out.println(" DAO : totalList 저장완료!");
